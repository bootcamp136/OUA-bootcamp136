...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Mouse0) && Grounded==true && _input.sprint==false)
            {
            ...
            if ((Input.GetKeyDown(KeyCode.C) && Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.C) && Input.GetKeyDown(KeyCode.S)) && Grounded == true && !Input.GetKeyDown(KeyCode.Mouse0))
            {
                Debug.Log("Triggerlandı");
